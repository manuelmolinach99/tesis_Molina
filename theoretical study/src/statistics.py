...
# Ahora le agrego la visualizacion de los datos originales, sin corregir etiquetas
file = open('../data/MyoArmband_data_origin.pickle', 'rb')
MyoArm_data = pickle.load(file)
file.close()
...
ax.set_xlabel("Sujetos")
ax.set_ylabel("EMG (mV)")
plt.title("EMG vs Sujeto (Electrodo 1) ORIGIN")
...
# Adding title
plt.title("EMG vs Movimiento (Electrodo 1) ORIGIN")
